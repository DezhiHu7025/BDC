    ...
    window.UEDITOR_CONFIG = {
        ...
        , toolbars:[
            [
				...
				//粗體，斜體，下劃線，字元邊框，刪除線，上標，下標，清除格式，格式刷，自動排版，引用，純文字粘貼，前景色，背景色，有序列表，無序列表，全選，清空文檔，
				...
				//居左對齊，居中對齊，居右對齊，左右對齊，大寫，小寫
                'justifyleft', 'justifycenter', 'justifyright', 'justifyjustify', '|', 'touppercase', 'tolowercase', '|',
				//超鏈接，取消鏈接，錨點，默認，左浮動，右浮動，居中，
                'link', 'unlink', 'anchor', '|', 'imagenone', 'imageleft', 'imageright', 'imagecenter', '|',
				//插入圖片，表情，塗鴉，視頻，音樂，附件，百度地圖，谷歌地圖，插入Iframe，代碼語言，百度應用，分頁，範本，背景，
                'insertimage', 'emotion', 'scrawl', 'insertvideo', 'music', 'attachment', 'map', 'gmap', 'insertframe','insertcode', 'webapp', 'pagebreak', 'template', 'background', '|',
				//分割線，日期，時間，特殊字元，截圖，圖片轉存，
                'horizontal', 'date', 'time', 'spechars', 'snapscreen', 'wordimage', '|',
				//插入表格，刪除表格，表格前插入行，前插入行，刪除行，前插入列，刪除列，合併多個儲存格，右合併儲存格，下合併儲存格，完全拆分儲存格，拆分成行，拆分成列，圖表
                'inserttable', 'deletetable', 'insertparagraphbeforetable', 'insertrow', 'deleterow', 'insertcol', 'deletecol', 'mergecells', 'mergeright', 'mergedown', 'splittocells', 'splittorows', 'splittocols', 'charts', '|',
                //列印，查找替換，關於，從草稿箱載入
				'print', 'preview', 'searchreplace', 'help', 'drafts']
        ]
		*/
		//2014/02/10 ggb OA需求定制toolbars
		/*
		,toolbars: [
			[
				'source','|', 
				'undo', 'redo','|', 
				'touppercase', 'tolowercase','bold', 'italic', 'underline', 'fontborder', 
